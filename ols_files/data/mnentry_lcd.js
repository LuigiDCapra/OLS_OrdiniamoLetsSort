...
["", "$DDJ.U_Help", "Help", "help.svg", "help"], 
["", "$DDJ.U_Help", "Help", "help.svg", "aiuto"], 
["", "$DDJ.U_About", "About", "about.svg", "informazioni"]   
],

"+++ block PrevNext +++":[
["Previous",           "$DDJ.U_Prev_DDJ", "&lt;-", "prev.svg", "collezione precedente"], 
["Next",               "$DDJ.U_Next_DDJ", "-&gt;", "next.svg", "collezione seguente"]
],

"+++ block LoadSave +++":[
["Select Collection.", "$DDJ.U_InputData", "Select Collection", "input.svg", "seleziona la collezione"],
["Reload collection.", "$DDJ.U_Reload", "Reload Collection", "reload.svg", "ricarica"], 
["Save All Changes.",  "$DDJ.U_SaveAllChanges", "Save All Changes", "save3.svg", "salva tutte le modifiche", "opt_auth"],
...
"+++ block Edit +++":[
["Data set/reset.",    "$DDJ.U_Data_SetReset", "Data set/reset", "setreset.svg", "set reset", "opt_auth"],
["Change value.",      "$DDJ.U_EdtVal_DDJ", "Edit Value", "edit_value.svg", "modifica il valore", "opt_auth"],
["Edit Record.",       "$DDJ.U_EdtTup_DDJ", "Edit Record", "edit_tuple.svg", "mostra il record", "opt_auth"],
...
["New Record.",        "$DDJ.U_NewTup_DDJ", "New Record", "new_tuple.svg", "nuovo record", "opt_auth"],
["New n Records.",     "$DDJ.U_New_n_Tup", "New n Records", "new_n_tuple.svg", "nuovi record", "opt_auth"],
["Delete Record.",     "$DDJ.U_DelTup_DDJ", "Delete Record", "delete_tuple.svg", "cancella il record", "opt_auth"],
["Calendar",           "$Calendar.U_Show0", "Calendar", "calendar.svg", "calendario"]
],

"+++ block Filter +++":[
["Filter JS.",         "$DDJ.U_SetFilterJS", "Filter-JS", "filter_js.svg", "filtro javascript"],
["Wizard.",            "$DDJ.U_SetFilter2",  "Filter Wizard", "filter_2.svg", "wizard"],  
["Filter Query by Example.", "$DDJ.U_FilterQBE", "Filtro QbE", "filter_qbe.svg", "filtro qbe"], 
["Filter String.",     "$DDJ.U_SetFilterStr", "FilterStr", "filter_str.svg", "filtro stringa"], 
["Filter Equal.",      "$Filter.U_SetFilterEQ",  "FilterEQ", "filter_EQ.svg", "filtro uguale"], 
["Toggle Filter.",     "$DDJ.U_ToggleFilter", "Toggle Filter", "toggle_filter.svg", "commuta la selezione"],   
["Invert Filter.",     "$DDJ.U_InvertFilter", "Invert Filter", "invert_filter.svg", "inverti la selezione"],    
["Clear selection.",   "$DDJ.U_ClearFilter",  "Clear Filter", "clear_filter.svg", "annulla la selezione"],
["Go to line",         "$DDJ.U_GoTo", "GoTo", "goto.svg", "vai alla riga"]
],

"+++ block Test +++":[
["Test-1",             "U_Test1", "Test-1", "test-1.svg", "test-1"]
],
...
"+++ rem block PATH-GO +++":[
["PATH",               "U_Path0", "Path", "inbox.svg", "Percorso", "input", ["text"]],
["Submit PATH",        'U_Path', "Submit Path", "exe.svg", "imposta", "button", ["GO"]]
],
...
"+++ rem block PATH-SET +++":[
["PATH",               "U_Path0", "Path", "inbox.svg", "Percorso", "input", ["text"]],
["Load PATH",          'U_SetPath', "Load Path", "exe.svg", "carica", "button", ["SET"]],
["Submit PATH",        'U_Path', "Submit Path", "exe.svg", "imposta", "button", ["GO"]]
],
...
"+++ block Resources +++":[
["Open Resources",     "$FileMan.U_Show_Res", "Open Resources", "show.svg", "mostra risorsa"],
["",                   "$FileMan.U_Show_Res", "Open Resources", "show.svg", "apri risorsa"],
["Edit Resources",     "$XTG.U_Edit_Res",     "Edit Resources", "edit_res.svg",  "edita risorsa"],
...
"PopUp": [
["", "$DDJ.U_Help_PopUp",   "Help PopUp (OLS)","help.svg", "aiuto"],     // OLS
["", "$DDJ.U_Read_Record",  "Read aloud Touple's values.","", "leggi"],
["", "$DDJ.U_ShutUp",       "Shut up! Stop reading.","", "silenzio"],

["",  "U_Null",             "----","", ""],
["",  "$ExeCmd.U_Home",     "Home", "pg_home.svg", "Inizio pagina"],
["",  "$ExeCmd.U_End",      "End",  "pg_end.svg",  "Fine pagina"],
 
["",  "U_Null",             "----","", ""], 
["", "$DDJ.U_GoTo_Prv",     "goto prev", "goto_prv.svg", "goto prev"],
["", "$DDJ.U_GoTo_Nxt",     "goto next", "goto_nxt.svg", "goto next"],
...
"PopUp_Layout": [
["", "$DDJ.U_Help_PopUp",   "Help PopUp Layout","help.svg", "aiuto"],
["", "$DDJ.U_Read_Record",  "Read aloud Touple's values.","read.svg", "leggi"],
["", "$DDJ.U_ShutUp",       "Shut up! Stop reading.","shutup.svg", "silenzio"],

["", "$DDJ.U_EdtVal_DDJ",   "Edit Value", "edit_value.svg", "modifica il valore", "opt_auth"],
["", "$DDJ.U_EdtTup_DDJ",   "Edit Record", "edit_tuple.svg", "edit record", "opt_auth"],
["", "$DDJ.U_NewTup_DDJ",   "New Record", "new_tuple.svg", "nuovo record", "opt_auth"],
["", "$DDJ.U_DelTup_DDJ",   "Delete Record", "delete_tuple.svg", "cancella il record", "opt_auth"],
["", "$DDJ.U_ClearFilter",  "Clear Filter", "clear_filter.svg", "annulla la selezione"],

["", "U_Null",              "----","", ""],      
["", "$DDJ.U_Refresh",      "Refresh View", "refresh.svg", "rinfresca"], 
["", "U_Null",              "----","", ""],
["", "U_Stat_Field",        "Column Statistics.","stat.svg", "statistiche campo"],
["", "U_Stat_Record",       "Table  Statistics.","stat.svg", "statistiche record"],
["", "U_Toggle_fLoad",      "Toggle Resourcess Loading.","", "commuta fLoad"],
...
"+++ block Standard +++":[
["Planes View.",       "$DDJ.U_Planes", "Planes View", "planes.svg", "piani di memoria"], 
["Transpose.",         "$DDJ.U_Transpose", "Transpose", "transpose.svg", "trasponi"],
...
["Move Up.",           "$DDJ.U_Move_Up", "Move Up",   "move_up.svg", "sposta in su"],    
["Move Dn.",           "$DDJ.U_Move_Dn", "Move Down", "move_dn.svg", "sposta in giù"],    
...
["Shell",              "$XTG.U_Shell", "shell", "shell.svg", "shell"],
["Root",               "$FileMan.U_Root", "root", "root.svg", "root"], 
["Back",               "$FileMan.U_Back", "back", "back.svg", "back"],
["",                   "Expand", "", "", "+++ block Resources +++"],
["",                   "Expand", "", "", "+++ block PATH-GO +++"],

["Copy File.",         "$XTG.U_Copy_File",  "Copy File",   "copy_file.svg",   "copia file", ""],
["Paste File.",        "$XTG.U_Paste_File", "Paste File",  "paste_file.svg",  "incolla file", ""],
["New File.",          "$XTG.U_New_File",   "New File",    "new_file.svg",    "nuovo file", ""],
["Delete File.",       "$XTG.U_Del_File",   "Delete File", "delete_file.svg", "cancella il file", "opt_auth"],
...
["",                   "Expand", "", "", "+++ block Filter +++"],
["Show Dir Images",    "$XTG.U_Show_DirImg", "Show Dir Images", "show_dirimg.svg", "mostra immagini directory"],
...
["New Record",        "$Card.U_New_Tup",       "New",       "new_tuple.svg", "crea una nuova scheda", "opt_auth"],
["",                  "$Card.U_New_Tup",       "New",       "new_tuple.svg", "crea un nuova record", "opt_auth"],
["Save",              "$Card.U_Save_Tup",      "Save",      "save2.svg", "salva", "opt_auth"],
["Reload Record",     "$Card.U_ReLoad_Tup",    "ReLoad",    "reload_card.svg", "ricarica la scheda"],
["",                  "$Card.U_ReLoad_Tup",    "ReLoad",    "reload_card.svg", "ricarica il record"],
["Copy",              "$Card.U_Copy_Tup",      "Copy",      "copy.svg", "copia"],
["Paste",             "$Card.U_Paste_Tup",     "Paste",     "paste.svg", "incolla", "opt_auth"],
["Clear",             "$Card.U_Clear_Tup",     "Clear",     "clear.svg", "cancella"],
...
["Toggle info",      "$Card.U_ToggleType",    "Type",      "toggle_type.svg", "mostra informazioni"],
["Toggle RO",        "$Card.U_ToggleRO",      "Read Only", "toggle_ro.svg", "commuta scrittura"],
["Help",             "$DDJ.U_Help",      "Help",   "help.svg", "aiuto"],
["Snap shot.",         "$DDJ.U_Snap", "Snap", "snap.svg", "fotografa"], 
...
["Last Record",      "$ExeCmd.U_Last_Tup1",   "Last",      "last.svg", "fine"],
["Read Aloud",       "$Card.U_Read_Tup",      "Read Aloud","read.svg", "leggi"],
["Reset counters",   "$Flash_Cards.U_Reset_iCnt",  "Reset counters","reset_cnt.svg", "azzera"],
["Shut Up",          "$Card.U_ShutUp",        "Shut Up",   "shutup.svg", "zitta"],
["Help",             "$DDJ.U_Help",      "Help",   "help.svg", "aiuto"],
...
"Filter_QBE": [
["delete",      "$Card.U_Clear_Tup",  "Clear", "clear.svg", "cancella"],
["copy",        "$Card.U_Copy_Tup",   "Copy",  "copy.svg", "copia"],
["paste",       "$Card.U_Paste_Tup",  "Paste", "paste.svg", "incolla"],
["Help file",   "$DDJ.U_Help", "Help",  "help.svg", "aiuto"],
["",                   "Insert", "", "", "++ Card ++"]
],
...
"Slide": [
["Previous",           "$DDJ.U_Prev_DDJ", "&lt;-", "prev.svg", "precedente"], 
["Next",               "$DDJ.U_Next_DDJ", "-&gt;", "next.svg", "seguente"],  
["slide",              "$DDJ.U_Slide", "slide", "slide.svg", "slide"]
],

"Stat": [
["Build the frequencies table", "$Stat_DDJ.U_Freq",          "Build the frequencies table",  "freq.svg", "costruisci la tabella delle frequenze"],
["Save statistics in Clipboard","$Stat_DDJ.U_Stat_Clipboard","Save statistics in Clipboard", "stat.svg", "salva le statistiche nella clipboard"],
["Save histogram in Clipboard", "$Stat_DDJ.U_Hist_Clipboard","Save histogram in Clipboard",  "histog.svg", "salva l'istogramma nella clipboard"],
["Help file",                   "$DDJ.U_Help",              "Help", "help.svg", "aiuto"]
],
...
"Chart": [
["Select",   "$Chart.U_SelCol", "Select", "select.svg", "seleziona"], 
["Reset",    "$Chart.U_Reset", "Reset", "reset.svg", "reset"], 
["Help file","$DDJ.U_Help","Help", "help.svg", "aiuto"],
["",                   "Insert", "", "", "++ SetReset ++"]
],

"Concat": [
["Help file","$DDJ.U_Help","Help", "help.svg", "aiuto", "opt_auth"],
["",                   "Insert", "", "", "++ SetReset ++"]
],
...
"DDJ_Cfg": [
["Reset",    "$VConfig.U_Reset", "Reset", "reset.svg", "reset"],
["Help file","$DDJ.U_Help", "Help", "help.svg", "aiuto"]
],
...
["Previous Month.","$Calendar.U_PrevMonth", "Previous Month", "indietro_mese.svg", "indietro mese"],
["Next Month.",    "$Calendar.U_NextMonth", "Next Month",     "avanti_mese.svg",   "avanti mese"],
["Previous Year.", "$Calendar.U_PrevYear",  "Previous Year",  "indietro_anno.svg", "indietro anno"],
["Next Year.",     "$Calendar.U_NextYear",  "Next Year",      "avanti_anno.svg",   "avanti anno"],
["ToDay.",         "$Calendar.U_ToDay",     "To Day",         "oggi.svg",          "oggi"],
