...
* new CL_XDB0_as_
*/
class CL_XDB0_as_ extends CL_XDB0 {
...
static F_aFld_Make(P_Coll0)
{
  var Val0;
  var aFld = [];
  for (let szKey in P_Coll0) {
      Val0 = P_Coll0[szKey];
  } /* for */
  var szType_Elem = $Type.F_szType(Val0);
...
* new CL_UsrView0_as_
*/ 
class CL_UsrView0_as_ extends CL_UsrView0 {
  constructor(P_XDB, P_aFld, P_Bag_UsrView) {
    const C_jCd_Cur = C_jCd_as_;
...
* Make Index.
*/ 
function F_aNdx_Make(P_UsrView, P_jFld)
{
  var XDB0 = P_UsrView.XDB0;
  var Obj0 = XDB0.Coll0;
  var aFld = P_UsrView.aFld1;
